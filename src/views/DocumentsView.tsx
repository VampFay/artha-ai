                  ...
                  <motion.div key={doc.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-white rounded-2xl border border-stone/10 shadow-sm gap-4">
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto gap-4">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button onClick={() => onNavigate("document-verify" as ViewState, { id: doc.id })} className="flex items-center gap-1.5 px-4 py-2 bg-stone/5 hover:bg-stone/10 text-carbon rounded-xl text-sm font-medium transition-colors"><span>Review</span><ArrowRight className="w-4 h-4" /></button>
                      </div>
                    </div>
                  </motion.div>
                ))}
